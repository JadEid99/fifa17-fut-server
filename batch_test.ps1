...
"@
function Focus { $p=Get-Process -Name FIFA17 -EA SilentlyContinue; if($p -and $p.MainWindowHandle -ne [IntPtr]::Zero){[KS3]::SetForegroundWindow($p.MainWindowHandle)|Out-Null;Start-Sleep -ms 300;return $true};return $false }
